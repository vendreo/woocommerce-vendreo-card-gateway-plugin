...
}//end woocommerce_vendreo_card_plugin()
...
function add_woocommerce_vendreo_card_gateway($gateways) {
	...
	return $gateways;
}//end add_woocommerce_vendreo_card_gateway()
...
}//end declare_cart_checkout_blocks_compatibility()
...
function vendreo_card_register_order_approval_payment_method_type() {
	...
	include_once plugin_dir_path(__FILE__) . 'includes/php/vendreo-card-block.php';
...
}//end vendreo_card_register_order_approval_payment_method_type()